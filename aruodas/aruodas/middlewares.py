...
class ScrapeOpsFakeUserAgentMiddleware:
    ...
    def __init__(self, settings):
        ...
        self.scrapeops_endpoint = settings.get(
            'SCRAPEOPS_FAKE_USER_AGENT_ENDPOINT', 'http://headers.scrapeops.com')
        self.scrapeops_fake_user_agents_active = settings.getbool(
            'SCRAPEOPS_FAKE_USER_AGENT_ENABLED', False)
        self.scrapeops_num_results = settings.get('SCRAPEOPS_NUM_RESULTS')
        self.user_agents_list = []  # Initialize the user_agents_list
        self._get_user_agents_list()
        self._scrapeops_fake_user_agents_enabled()

    # The rest of your middleware class methods
